...
import { Users, Heart, Star, Globe, GitFork, ExternalLink, Loader2 } from "lucide-react";
...
const FALLBACK_CONTRIBUTORS: GitHubContributor[] = [
  {
    login: "mufthakherul",
    id: 130831166,
    avatar_url: "https://avatars.githubusercontent.com/u/130831166?v=4",
...
export default function ContributorsClient() {
  ...
  return (
    <>
      ...
      {/* Loading Skeletal or Content */}
      {loading ? (
        <section className="border-b border-white/5 py-24">
          <div className="flex flex-col items-center justify-center gap-3">
            <Loader2 className="h-8 w-8 animate-spin text-siyarix-500" />
            <p className="text-sm text-slate-400">Synchronizing live contributors from GitHub...</p>
          </div>
        </section>
      ) : (
        <>
